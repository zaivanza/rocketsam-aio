...
# LINEA : exc_withdraw (linea) => rocketsam 
track_1 = [
    {
    ...
    },
    {
        ...
        'description': '(linea)', # Additional Module Description
        'params': {
            'chain': 'linea', # Network where we are awaiting coins
...
# LINEA : exchange_withdraw (arbitrum) => zerius_refuel (arbitrum => linea) => rocketsam
track_2 = [
    {
        'module_name': 'exchange_withdraw', # Module Name
        'description': '(Binance ETH)', # Additional Module Description
    ...
    },
    {
        ...
        'description': '(arbitrum => linea)', # Additional Module Description
        'params': {
            'from_chain': ['arbitrum'], # From which network
            'to_chain': ['linea'], # To which network
...
# LINEA : okx_withdraw (linea) => rocketsam => transfer (linea)
track_3 = [
    {
    ...
    },
    {
        ...
        'description': '(linea)', # Additional Module Description
        'params': {
            'chain': 'linea', # Network to withdraw to
...
# LINEA : okx_withdraw (linea) => rocketsam => orbiter_bridge (linea => arbitrum) => transfer (arbitrum)
track_4 = [
    {
        'module_name': 'okx_withdraw', # Module Name
        'description': '(Arbitrum ETH)', # Additional Module Description
    ...
    },
    {
        ...
        'description': '(linea => arbitrum)', # Additional Module Description
        'params': {
            'from_chain': ['linea'], # From which network
...
# LINEA : okx_withdraw (arbitrum) => orbiter_bridge (arbiturm => linea) => rocketsam => orbiter_bridge (linea => arbitrum) => transfer (arbitrum)
track_5 = [
    {
        'module_name': 'okx_withdraw', # Module Name
        'description': '(Arbitrum ETH)', # Additional Module Description
