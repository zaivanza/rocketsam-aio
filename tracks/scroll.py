...
# SCROLL : exc_withdraw (scroll) => rocketsam 
track_1 = [
    {
    ...
    },
    {
        ...
        'description': '(scroll)', # Additional Module Description
        'params': {
            'chain': 'scroll', # Network where we are awaiting coins
...
# SCROLL : exchange_withdraw (arbitrum) => zerius_refuel (arbitrum => scroll) => rocketsam
track_2 = [
    {
        'module_name': 'exchange_withdraw', # Module Name
        'description': '(Binance ETH)', # Additional Module Description
    ...
    },
    {
        ...
        'description': '(arbitrum => scroll)', # Additional Module Description
        'params': {
            'from_chain': ['arbitrum'], # From which network
            'to_chain': ['scroll'], # To which network
...
# SCROLL : okx_withdraw (arbitrum) => orbiter_bridge (arbiturm => scroll) => rocketsam => orbiter_bridge (scroll => arbitrum) => transfer (arbitrum)
track_3 = [
    {
    ...
    {
        'module_name': 'orbiter_bridge', # Module Name
        'description': '(scroll => arbitrum)', # Additional Module Description
        'params': {
            'from_chain': ['scroll'], # From which network
