...
# ZORA : exc_withdraw (zora) => rocketsam 
track_1 = [
    {
    ...
    },
    {
        ...
        'description': '(zora)', # Additional Module Description
        'params': {
            'chain': 'zora', # Network where we are awaiting coins
...
# ZORA : exchange_withdraw (arbitrum) => zerius_refuel (arbitrum => zora) => rocketsam
track_2 = [
    {
        'module_name': 'exchange_withdraw', # Module Name
        'description': '(Binance ETH)', # Additional Module Description
    ...
    },
    {
        ...
        'description': '(arbitrum => zora)', # Additional Module Description
        'params': {
            'from_chain': ['arbitrum'], # From which network
            'to_chain': ['zora'], # To which network
...
# ZORA : okx_withdraw (arbitrum) => orbiter_bridge (arbiturm => zora) => rocketsam => orbiter_bridge (zora => arbitrum) => transfer (arbitrum)
track_3 = [
    {
    ...
    {
        'module_name': 'orbiter_bridge', # Module Name
        'description': '(zora => arbitrum)', # Additional Module Description
        'params': {
            'from_chain': ['zora'], # From which network
...
# ZORA : okx_withdraw (ethereum) => zksync_bridge (ethereum => zora) => rocketsam => orbiter_bridge (zora => arbitrum) => transfer (arbitrum)
track_4 = [
    {
        'module_name': 'okx_withdraw', # Module Name
        'description': '(Arbitrum ETH)', # Additional Module Description
    ...
    },
    {
        ...
        'params': {
            ...
            'amount_to': 0, # Transfer up to a certain amount of coins
            'transfer_all_balance': True, # True / False. If True, then transfer the entire balance
            'min_amount_transfer': 0.002, # If the balance is less than this amount, no transfer will be made
            'keep_value_from': 0.001, # How many coins to keep on the wallet (only works when: transfer_all_balance = True)
